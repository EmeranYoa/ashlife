...
class Plan {
  ...
  String toString() {
    ...
    buffer.write("id=" + "$id" + ", ");
    buffer.write(
        "name=" + (_name != null ? enumToString(_name)! : "null") + ", ");
    buffer.write(
    ...
    buffer.write("currency=" +
        (_currency != null ? enumToString(_currency)! : "null") +
        ", ");
    buffer.write(
  ...
  Plan.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        _name = enumFromString<PLAN_TYPE>(json['name'], PLAN_TYPE.values),
        _limit = (json['limit'] as num?)?.toInt(),
        _nbTraining = (json['nbTraining'] as num?)?.toInt(),
        _size = (json['size'] as num?)?.toInt(),
        _price = (json['price'] as num?)?.toDouble(),
        _currency = enumFromString<CURRENCY>(json['currency'], CURRENCY.values),
        _duration = (json['duration'] as num?)?.toInt();

  Map<String, dynamic> toJson() => {
        'id': id,
        'name': enumToString(_name),
        'limit': _limit,
        'nbTraining': _nbTraining,
        'size': _size,
        'price': _price,
        'currency': enumToString(_currency),
        'duration': _duration
      };
